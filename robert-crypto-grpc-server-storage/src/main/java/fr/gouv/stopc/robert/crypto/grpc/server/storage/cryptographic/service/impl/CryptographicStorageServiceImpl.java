...
public class CryptographicStorageServiceImpl implements ICryptographicStorageService {
    ...
    public boolean contains(String alias) {
        ...
        try {
            ...
            log.info("An expected error occurred when trying to check containing the alias {} due to {}", alias, e.getMessage());
        }
        return false;
    }

    /**
     * Register key (register-key in HSM)
     * @return
     */
    @Override
    ...
    private byte[] getServerKey(LocalDate dateFromEpoch) {
        ...
        try {
            ...
            log.error("An expected error occurred when trying to store the alias {} due to {}", dateFromEpoch, e.getMessage());
        }
